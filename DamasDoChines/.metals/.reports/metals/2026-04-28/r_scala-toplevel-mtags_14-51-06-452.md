error id: file://<WORKSPACE>/src/Score.scala:[310,310) in virtfile:file://<WORKSPACE>/src/Score.scala(... e)
}

def )
file://<WORKSPACE>/file:<WORKSPACE>/src/Score.scala
file://<WORKSPACE>/src/Score.scala:18: error: expected identifier; obtained eof
