error id: file://<WORKSPACE>/src/Cli.scala:[2320,2321) in virtfile:file://<WORKSPACE>/src/Cli.scala(... 	}

	def 
}
)
file://<WORKSPACE>/file:<WORKSPACE>/src/Cli.scala
file://<WORKSPACE>/src/Cli.scala:93: error: expected identifier; obtained rbrace
