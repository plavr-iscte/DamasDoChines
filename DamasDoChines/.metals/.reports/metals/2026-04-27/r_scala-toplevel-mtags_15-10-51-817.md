error id: file://<WORKSPACE>/src/Cli.scala:[2841,2842) in virtfile:file://<WORKSPACE>/src/Cli.scala(... }

	
	def (): Unit =  ...)
file://<WORKSPACE>/file:<WORKSPACE>/src/Cli.scala
file://<WORKSPACE>/src/Cli.scala:120: error: expected identifier; obtained lparen
