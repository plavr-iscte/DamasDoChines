error id: file://<WORKSPACE>/src/Cli.scala:[2841,2843) in virtfile:file://<WORKSPACE>/src/Cli.scala(... }

	
	def do(): Unit = ...)
file://<WORKSPACE>/file:<WORKSPACE>/src/Cli.scala
file://<WORKSPACE>/src/Cli.scala:120: error: expected identifier; obtained do
