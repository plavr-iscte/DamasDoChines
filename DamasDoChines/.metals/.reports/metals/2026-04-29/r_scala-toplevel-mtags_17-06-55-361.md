error id: file://<WORKSPACE>/src/code/Main.scala:[1999,2002) in virtfile:file://<WORKSPACE>/src/code/Main.scala(... 	def 

	
	def readInput ...)
file://<WORKSPACE>/file:<WORKSPACE>/src/code/Main.scala
file://<WORKSPACE>/src/code/Main.scala:93: error: expected identifier; obtained def
