error id: file://<WORKSPACE>/src/code/Engine.scala:scala/io/StdIn#readLine(+1).
file://<WORKSPACE>/src/code/Engine.scala
empty definition using pc, found symbol in pc: 
found definition using semanticdb; symbol scala/io/StdIn#readLine(+1).
