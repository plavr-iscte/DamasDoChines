error id: file://<WORKSPACE>/src/Engine.scala:scala/Any#asInstanceOf().
file://<WORKSPACE>/src/Engine.scala
empty definition using pc, found symbol in pc: scala/Any#asInstanceOf().
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -scala/collection/parallel/CollectionConverters.rsN.asInstanceOf.
	 -scala/collection/parallel/CollectionConverters.rsN.asInstanceOf#
	 -scala/collection/parallel/CollectionConverters.rsN.asInstanceOf().
	 -rsN/asInstanceOf.
	 -rsN/asInstanceOf#
	 -rsN/asInstanceOf().
	 -scala/Predef.rsN.asInstanceOf.
	 -scala/Predef.rsN.asInstanceOf#
	 -scala/Predef.rsN.asInstanceOf().
offset: 3913
