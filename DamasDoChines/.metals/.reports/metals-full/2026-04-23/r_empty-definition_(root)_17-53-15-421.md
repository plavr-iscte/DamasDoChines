error id: file://<WORKSPACE>/src/Engine.scala:code/Engine#randomMove().(lstOpenCoords)
file://<WORKSPACE>/src/Engine.scala
empty definition using pc, found symbol in pc: 
found definition using semanticdb; symbol code/Engine#randomMove().(lstOpenCoords)
