error id: file://<WORKSPACE>/src/Main.scala:initboard.
file://<WORKSPACE>/src/Main.scala
empty definition using pc, found symbol in pc: initboard.
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -scala/collection/parallel/CollectionConverters.engine.initboard.
	 -scala/collection/parallel/CollectionConverters.engine.initboard#
	 -scala/collection/parallel/CollectionConverters.engine.initboard().
	 -engine/initboard.
	 -engine/initboard#
	 -engine/initboard().
	 -scala/Predef.engine.initboard.
	 -scala/Predef.engine.initboard#
	 -scala/Predef.engine.initboard().
offset: 702
...
object Main {
	...
	def main(args: Array[String]): Unit = {
		...
		val (initialBoard, r1, initialOpenCoords) = engine.initboa@@rd(rowLength, colLength, startRandom)
