error id: file://<WORKSPACE>/src/Main.scala:getCommand.
file://<WORKSPACE>/src/Main.scala
empty definition using pc, found symbol in pc: getCommand.
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -scala/collection/parallel/CollectionConverters.client.getCommand.
	 -scala/collection/parallel/CollectionConverters.client.getCommand#
	 -scala/collection/parallel/CollectionConverters.client.getCommand().
	 -client/getCommand.
	 -client/getCommand#
	 -client/getCommand().
	 -scala/Predef.client.getCommand.
	 -scala/Predef.client.getCommand#
	 -scala/Predef.client.getCommand().
offset: 257
...
object Main {
	...
	def main(args: Array[String]): Unit = {
		...
		client.getComm@@and("Start game? (type start)", "start")
	}
