error id: file://<WORKSPACE>/src/Main.scala:nextInt.
file://<WORKSPACE>/src/Main.scala
empty definition using pc, found symbol in pc: nextInt.
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -scala/collection/parallel/CollectionConverters.r.nextInt.
	 -scala/collection/parallel/CollectionConverters.r.nextInt#
	 -scala/collection/parallel/CollectionConverters.r.nextInt().
	 -r/nextInt.
	 -r/nextInt#
	 -r/nextInt().
	 -scala/Predef.r.nextInt.
	 -scala/Predef.r.nextInt#
	 -scala/Predef.r.nextInt().
offset: 2379
