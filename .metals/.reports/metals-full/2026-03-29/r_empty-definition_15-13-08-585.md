error id: file:///C:/Users/migue/Documents/DamasDoChines/DamasDoChines/src/T1.scala:_1.
file:///C:/Users/migue/Documents/DamasDoChines/DamasDoChines/src/T1.scala
empty definition using pc, found symbol in pc: _1.
...
def play(board:Board, player: Stone,coordFrom:Coord2D,coordTo:Coord2D,lstOpenCoords:List[Coord2D]):(Option[Board],List[Coord2D]) = {
    def getDir():(Option[Coord2D])={
        if((coordTo._@@1-coordFrom._1==2)&&())
                return Coord2D(coordFrom._1+1,)
    }
    def verCap(dir:Int):(Boolean,Board,List[Coord2D])={
        if(player==board.get(coordFrom)) then        
            val coordMid=()
...
def playRandomly(board:Board, r:MyRandom, player:Stone, lstOpenCoords:List[Coord2D], f:(List[Coord2D],MyRandom)=>(Coord2D,MyRandom)):(Option[Board],MyRandom,List[Coord2D],Option[Coord2D]) = {
    ...
    val teste = List((rCoord._1 - 2, rcoord._2), (rCoord._1 + 2, rCoord._2))
