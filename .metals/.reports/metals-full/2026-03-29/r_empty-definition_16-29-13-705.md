error id: file:///C:/Users/migue/Documents/DamasDoChines/DamasDoChines/src/Main.scala:
file:///C:/Users/migue/Documents/DamasDoChines/DamasDoChines/src/Main.scala
...
offset: 3384
uri: file:///C:/Users/migue/Documents/DamasDoChines/DamasDoChines/src/Main.scala
text:
```scala
package code
object Main  = {
...
def playRandomly(board:Board, r:MyRandom, player:Stone, lstOpenCoords:List[Coord2D], f:(List[Coord2D],MyRandom)=>(Coord2D,MyRandom)):(Option[Board],MyRandom,List[Coord2D],Option[Coord2D]) = {
    ...
    @tailrec
    def tryCoordinates(l:L@@ist[Coord2D]):(Option[Board],MyRandom,List[Coord2D],Option[Coord2D]):(Option[Board],List[Coord2D]) = l match {
        case Nil =>(None,l)
        case x :: xs => {
